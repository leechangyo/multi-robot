...
path = Home + '/models/camera/model.sdf'
...
class Spawn():
	...
	def spawning(self,):
		...
		item_pose   =   Pose(Point(x=self.x_model_pose, y=self.y_model_pose,    z=1.0),   Quaternion(0.,0.,0.7071,0.7071))
...
def main():
	...
	object1 = Spawn("camera", Spawning, 0.6, 1)
	object1.spawning()
